    ...
    include: [
      {
        model: db.Deal,
        as: 'deal',
        attributes: ['id', 'deal_number', 'title', 'status', 'deal_type', 'deal_date', 'total', 'vat_percentage', 'vat_amount', 'subtotal', 'currency', 'is_rcm_applicable', 'downstream_partner_supplier_id', 'supplier_id', 'pickup_location', 'pickup_contact_name', 'pickup_contact_number'],
        include: [
